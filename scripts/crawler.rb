...
imdb_create_box_office_list = crawler.address("https://www.imdb.com/list/ls066605728/")

# Imdb Box Office Css Tag
top_box_office_css = crawler.css_tag(".lister-item-header > a")
#-------------------------------------------------------------------------------
